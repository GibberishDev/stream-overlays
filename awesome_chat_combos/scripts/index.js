...
new SettingColor("textcolor","#ffff00ff","Display timer", "Decides whether to show or hide combo expiration timer")


initSettings()
// #endregion

console.log(registeredSettings.get("channels").value)